...
| FLUX.1, SD3/3.5 | 🔴 | 🔴 | — | Not attempted this pass — no local weights, no download automation yet; source exists (`FluxDiT.cs`, `SD3/Sd3Pipeline.cs`, `Flux2`/`Flux3`) but its current completeness is unverified |
