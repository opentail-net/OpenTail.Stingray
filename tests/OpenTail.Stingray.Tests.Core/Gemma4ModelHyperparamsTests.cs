...
public sealed class Gemma4ModelHyperparamsTests
{
    private static Dictionary<string, object> BuildE4BMetadata()
    {
        ...
        return new Dictionary<string, object>
        {
            ...
            ["_opentailllm.has_ple"]                              = true,
            ["_opentailllm.has_post_attn_norm"]                   = true,
            ["_opentailllm.has_post_ffw_norm"]                    = true,
            ["_opentailllm.has_layer_output_scale"]               = true,
        };
    }
    ...
    private static Dictionary<string, object> Build12BDenseMetadata()
    {
        ...
        return new Dictionary<string, object>
        {
            ...
            ["gemma4.final_logit_softcapping"]               = 30.0f,
            // No "_opentailllm.has_ple" — dense 12B has no PLE.
            ["_opentailllm.has_post_attn_norm"]                   = true,
            ["_opentailllm.has_post_ffw_norm"]                    = true,
            ["_opentailllm.has_layer_output_scale"]               = true,   // present on dense (deviates from plan)
            ["_opentailllm.attention_k_eq_v"]                     = true,   // global layers reuse K as V
        };
    }
