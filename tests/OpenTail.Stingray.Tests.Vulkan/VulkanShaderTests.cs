...
public sealed unsafe class VulkanShaderTests : HeavyTestBase
{
    ...
    public void MatVecQ4KMatchesCpu()
    {
        ...
        OpenTail.Stingray.Cpu.Dequantize.ToFloat32(rawData, f32Weights, qInfo.DType, totalElements);
        ...
        byte[] weightBytes, int matRows, int matCols, DType dtype, int inputSeed)
    {
        ...
        var f32Weights = new float[totalElements];
        OpenTail.Stingray.Cpu.Dequantize.ToFloat32(weightBytes, f32Weights, dtype, totalElements);
    ...
    public void GpuForwardPassMatchesCpuOutput()
    {
        ...
        int cpuTop = OpenTail.Stingray.Engine.Sampler.Greedy(cpuLogits);
        int gpuTop = OpenTail.Stingray.Engine.Sampler.Greedy(gpuLogits);
        ...
        for (int i = 0; i < 5; i++)
        {
            int cpuNext = OpenTail.Stingray.Engine.Sampler.Greedy(cpuLogits);
            int gpuNext = OpenTail.Stingray.Engine.Sampler.Greedy(gpuLogits);
    ...
    public void TurboQuantKvCache_UsesLayerIndexBaseForCompressors()
    {
        ...
        using var cache = new OpenTail.Stingray.Engine.TurboQuantKvCache(
    ...
    public void HybridForwardPassTurboQuantRunsPastFp32Window()
    {
        ...
        using var hybridFwd = new OpenTail.Stingray.Engine.HybridForwardPass(
    ...
    private static void AssertHybridForwardPassProducesCoherentDecode(
        OpenTail.Stingray.Engine.HybridForwardPass hybridFwd,
    ...
    public void GdnConv1dDecodeMatchesCpu()
    {
        ...
        OpenTail.Stingray.Cpu.GdnKernels.CausalDepthwiseConv1dDecode(
    ...
    public void GdnL2NormPerHeadMatchesCpu(int elementOffset)
    {
        ...
        OpenTail.Stingray.Cpu.GdnKernels.L2NormPerHead(cpuRegion, numHeads, headDim, eps);
    ...
    public void GdnTileHeadsMatchesCpu(int srcOffset, int dstOffset)
    {
        ...
        OpenTail.Stingray.Cpu.GdnKernels.TileHeads(cpuSrc, cpuDst, srcHeads, repeat, headDim);
    ...
    public void GdnRecurrenceDecodeMatchesCpu()
    {
        ...
        OpenTail.Stingray.Cpu.GdnKernels.GdnRecurrenceDecode(
