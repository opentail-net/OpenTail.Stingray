...
/// <see cref="CudaHybridForwardPass"/> (STINGRAY_CPU_MOE=1). In that mode the GPU runs
...
public sealed class CudaHybridForwardPassCpuMoeTests
{
    ...
    public void CudaHybridForwardPass_CpuMoeMode_MatchesCpuReference()
    {
        ...
        try
        {
            ...
            // GpuLayers = NumLayers is the "user wants GPU" hint; with STINGRAY_CPU_MOE=1
            ...
            using var cpu = new OpenTail.Stingray.Engine.ForwardPass(model, cpuBackend, hp);
