...
public sealed class Gemma4Cuda12BForwardPassTests : IDisposable
{
    ...
    public void Gemma4_12B_CpuForward_ProducesCoherentDecode()
    {
        ...
        using var fwd = new OpenTail.Stingray.Engine.ForwardPass(model, backend, hp, maxContextLength: 4096);
    ...
    public void Gemma4_12B_CpuMatchesCudaLogits()
    {
        ...
        using (var cpuFwd = new OpenTail.Stingray.Engine.ForwardPass(model, cpuBackend, hp, maxContextLength: 4096))
