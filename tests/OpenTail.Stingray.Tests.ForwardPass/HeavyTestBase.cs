...
/// only pays for the fast OpenTail.Stingray.Tests.ForwardPass.Fast suite (no real model, runs
/// in parallel). Set <c>STINGRAY_RUN_HEAVY_TESTS=1</c> to actually run this suite — e.g. before
/// a commit, or in CI.
/// </summary>
