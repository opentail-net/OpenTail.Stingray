...
public sealed class CudaBatchForwardMultiTests
{
    ...
    /// <summary>
    /// #201 oracle for the opt-in decode MMQ (<c>STINGRAY_BATCH_DECODE_MMQ=1</c>): the int8
    ...
    public void Qwen3_8B_BatchForwardMulti_DecodeMmq_MatchesSingleUser()
    {
        ...
        finally { Environment.SetEnvironmentVariable("STINGRAY_BATCH_DECODE_MMQ", prevMmq); }
    ...
    /// int8 mma kernel — this one does. N=6 (3×PromptA, 3×PromptB) with STINGRAY_BATCH_DECODE_MMQ=1
