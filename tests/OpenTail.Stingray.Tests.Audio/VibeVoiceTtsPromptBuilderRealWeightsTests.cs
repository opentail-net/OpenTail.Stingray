...
/// <summary>
/// Real, live end-to-end smoke test wiring VibeVoice TTS's real prompt-template tokenizer
/// (ported this session, previously "separate, unstarted work" per
/// <see cref="VibeVoiceGeneratorRealWeightsTests"/>'s doc comment) into the full real generation
/// loop -- the first real-script-driven (not raw-token-id) generation run for this model.
/// </summary>
public sealed class VibeVoiceTtsPromptBuilderRealWeightsTests : HeavyTestBase
{
    ...
    [Fact]
    public void BuildPrompt_ThenGenerate_OnRealCheckpoint_ProducesFiniteNonSilentAudio()
    {
        ...
        string script = "Speaker 1: Hello there, this is a real prompt template test.\nSpeaker 2: And this is the second speaker's real line.";
        ...
        Assert.Equal(SpeechStartId, promptTokenIds[^1]);
