...
public sealed class CudaHybridGdnSnapKvTests
{
    ...
    public void CudaHybridGdnSnapKv_LongPrompt_CacheShrinksToBudget_DecodeStaysWellFormed()
    {
        ...
        {
            Environment.SetEnvironmentVariable("STINGRAY_SNAPKV_BUDGET", prev);
        }
    }
    ...
    /// <summary>
    /// With <c>STINGRAY_SNAPKV_BUDGET</c> unset and a small configured context,
    ...
    /// <summary>
    /// When <c>STINGRAY_SNAPKV_BUDGET</c> is explicitly set to <c>0</c>, eviction
    ...
    public void SnapKvConfig_FromEnvironment_DistinguishesUnsetFromZero()
    {
        ...
        try
        {
            ...
            Environment.SetEnvironmentVariable("STINGRAY_SNAPKV_BUDGET", "1024");
