...
public sealed class CudaTurboQuantBench
{
    ...
    // instead — set STINGRAY_BENCH_CUDA_TQ=1 to actually run the timing.
    private static bool BenchEnabled => Environment.GetEnvironmentVariable("STINGRAY_BENCH_CUDA_TQ") == "1";
