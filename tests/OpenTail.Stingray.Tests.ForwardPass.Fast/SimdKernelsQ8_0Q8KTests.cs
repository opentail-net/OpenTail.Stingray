...
///      the engine today; only <c>STINGRAY_Q3K_Q8K</c> is wired.
///
...
public sealed unsafe class SimdKernelsQ8_0Q8KTests
{
    ...
    /// today: only <c>STINGRAY_Q3K_Q8K</c> is wired in HybridGdnForwardPass
    /// and CudaHybridGdnForwardPass; the DType.Q8_0 routed-expert branch
    /// still calls <c>DotQ8_0</c> unconditionally. Any future
    /// <c>STINGRAY_Q8_0_Q8K</c> gate would dispatch to the same kernel
    /// covered here.
    /// </summary>
    [Fact]
