...
/// STINGRAY_PREFAULT kill switch / RAM-fit skip (which must bail out before touching the
...
public sealed class MmapPrefaultTests
{
    ...
    {
        var prev = Environment.GetEnvironmentVariable("STINGRAY_PREFAULT");
        Environment.SetEnvironmentVariable("STINGRAY_PREFAULT", null); // auto
    ...
    {
        var prev = Environment.GetEnvironmentVariable("STINGRAY_PREFAULT");
        Environment.SetEnvironmentVariable("STINGRAY_PREFAULT", null);
    ...
    {
        var prev = Environment.GetEnvironmentVariable("STINGRAY_PREFAULT");
        Environment.SetEnvironmentVariable("STINGRAY_PREFAULT", "0");
