...
(`opentail-llm-cli perplexity`) is evaluated on the standard wikitext-2-raw test split
...
instead, e.g.:
  Get-Content docs/OpenTail.Stingray-Design.md -Raw | Set-Content scripts/kvarn-gate/wiki.test.raw
