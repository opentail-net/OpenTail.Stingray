...
# STINGRAY_ACT_SOA=1 (SoA Q8_1 activations: llm_quantize_q8_1_soa + llm_mmq_*_soa_acts)
# vs unset (interleaved 36-B AoS Q8_1). Weights stay SoA (STINGRAY_MMQ_SOA default on), so
...
Remove-Item Env:\STINGRAY_ACT_SOA
