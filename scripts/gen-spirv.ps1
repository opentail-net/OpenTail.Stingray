# Regenerates src/OpenTail.Stingray.Vulkan/Shaders.Precompiled.g.cs from the GLSL shader
...
Write-Host "Building OpenTail.Stingray.Vulkan ($Configuration)..."
dotnet build "$repoRoot\src\OpenTail.Stingray.Vulkan" -c $Configuration | Out-Null
...
Write-Host "Done. Rebuild OpenTail.Stingray.Vulkan to pick up the regenerated table."
