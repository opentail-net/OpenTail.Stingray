# Issue #156 decode A/B: Qwen3-8B Q4_K CUDA, interleaved (STINGRAY_Q4K_SOA=0) vs
# scale-pre-unpacked SoA decode matvec + prefill MMQ (STINGRAY_Q4K_SOA=1). Same prompt,
# warm, --temp 0, 160-token decode. Reports prefill + decode t/s per config.
$ErrorActionPreference = "Continue"
$M = "C:\p\opentail-llm\models\Qwen3-8B-Q4_K_M.gguf"
$exe = "C:\p\opentail-llm\src\OpenTail.Stingray.Cli\bin\Release\net10.0\opentail-llm-cli.exe"
