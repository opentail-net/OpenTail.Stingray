...
# three configurations: Q8K gates OFF (current baseline), STINGRAY_Q3K_Q8K=1
...
# weights: Q3_K + Q8_0 + Q4_K / Q5_K), so STINGRAY_CPU_MOE=1 is set throughout.
param(
...
Remove-Item env:STINGRAY_Q3K_Q8K -ErrorAction SilentlyContinue
Remove-Item env:STINGRAY_Q8_0_Q8K -ErrorAction SilentlyContinue
...
try {
    ...
    $env:STINGRAY_Q3K_Q8K = "0"
    $env:STINGRAY_Q8_0_Q8K = "0"
