# Smoke test: launch OpenTail.Stingray.Server.Host with Gemma 4 E4B Q8 and hit
...
$env:STINGRAY_MODEL = $ModelPath
$env:ASPNETCORE_URLS = "http://127.0.0.1:$Port"

# Force CPU backend via STINGRAY_BACKEND env var. The smoke test targets the
...
# STINGRAY_N_GPU_LAYERS=22 when you want to exercise the hybrid path here too.
...
$proc = Start-Process -FilePath "dotnet" `
    -ArgumentList @("run", "--project", "src/OpenTail.Stingray.Server.Host", "-c", "Release") `
