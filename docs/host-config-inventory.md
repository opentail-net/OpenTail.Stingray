...
| `DSparkModelPath` | `string?` | | Optional path to a DSpark draft head — model.safetensors, or its directory with config.json alongside (docs/dspark-plan.md, PR #413 Phase 6). Set via this property or the OPENTA... |
