...
*Captured 2026-05-19 from `E:\models\Qwen3.6-35B-A3B-UD-Q4_K_M.gguf` via `opentail-llm-cli list-tensors`, cross-referenced against [llama.cpp's `src/models/qwen35moe.cpp`](https://github.com/ggml-org/llama.cpp/blob/master/src/models/qwen35moe.cpp) and `src/models/delta-net-base.cpp` on master. These findings supersede `qwen35moe-plan.md` where they conflict.*
...
## Key implementation notes for OpenTail.Stingray port
