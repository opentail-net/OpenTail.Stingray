...
- `src/OpenTail.Stingray.Core/ModelGraph.cs:289` (NEOX-RoPE allowlist) — lists `gemma4`
- `src/OpenTail.Stingray.Core/ModelGraph.cs:352` — `isGemma4 = arch.Equals("gemma4", …)`
- `src/OpenTail.Stingray.Engine/CudaHybridForwardPass.cs` — `_isGemma4Like`
