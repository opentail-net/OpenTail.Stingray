...
///
/// <para>Tunable via <c>STINGRAY_PREFAULT</c>: <c>0</c> disables all prefaulting,
...
internal static unsafe partial class MmapPrefault
{
    ...
    internal enum RamGate
    {
        ...
        /// <summary>Always sweep (subject only to the <c>STINGRAY_PREFAULT=0</c> kill
    ...
    /// <c>STINGRAY_PREFAULT</c> value (null = unset).
    /// </summary>
