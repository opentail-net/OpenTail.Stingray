...
/// <list type="bullet">
///   <item><c>STINGRAY_MOE_WARMPIN</c> — number of hottest experts to pin <i>per layer</i>
...
///   <item><c>STINGRAY_MOE_WARMPIN_AFTER</c> — number of expert accesses to observe
...
{
    public static readonly int PerLayer = ParseInt("STINGRAY_MOE_WARMPIN", 0, allowZero: true);
    public static readonly long AfterAccesses = ParseLong("STINGRAY_MOE_WARMPIN_AFTER", 512, allowZero: false);
