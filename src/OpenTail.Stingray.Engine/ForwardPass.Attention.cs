            ...
            if (bf16)
            {
                ...
                else if (Fma.IsSupported && hdLocal == 128)
                {
                    ...
                    for (int i = 0; i < scoreLen; i++)
                    {
                        ...
                        a6 = Fma.MultiplyAdd(wv, SimdKernels.WidenBf16(vVec + 48), a6);
                        a7 = Fma.MultiplyAdd(wv, SimdKernels.WidenBf16(vVec + 56), a7);
                        a8 = Fma.MultiplyAdd(wv, SimdKernels.WidenBf16(vVec + 64), a8);
                        a9 = Fma.MultiplyAdd(wv, SimdKernels.WidenBf16(vVec + 72), a9);
                        a10 = Fma.MultiplyAdd(wv, SimdKernels.WidenBf16(vVec + 80), a10);
                        a11 = Fma.MultiplyAdd(wv, SimdKernels.WidenBf16(vVec + 88), a11);
                        a12 = Fma.MultiplyAdd(wv, SimdKernels.WidenBf16(vVec + 96), a12);
                        a13 = Fma.MultiplyAdd(wv, SimdKernels.WidenBf16(vVec + 104), a13);
                        a14 = Fma.MultiplyAdd(wv, SimdKernels.WidenBf16(vVec + 112), a14);
                        a15 = Fma.MultiplyAdd(wv, SimdKernels.WidenBf16(vVec + 120), a15);
                    }
