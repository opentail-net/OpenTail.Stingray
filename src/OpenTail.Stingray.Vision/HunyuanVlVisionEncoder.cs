...
public sealed unsafe class HunyuanVlVisionEncoder
{
    ...
    public HunyuanVlVisionEncoder(HunyuanVlVisionModel model)
    {
        ...
        _mmPreNormW   = Ptr<float>(gguf, "mm.pre_norm.weight");
        ...
        _mmPostNormW  = Ptr<float>(gguf, "mm.post_norm.weight");
        ...
        out int tokenCount)
    {
        ...
        if (_mmPreNormW != null)
            VisionOps.RmsNorm(x, nP, _embd, _mmPreNormW, _eps);
        ...
        if (_mmPostNormW != null)
            VisionOps.RmsNorm(proj, tokenCount, _projDim, _mmPostNormW, _eps);
