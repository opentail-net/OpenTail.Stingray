...
/// <summary>
/// Model container and metadata parser for Dots-OCR and PaddleOCR-VL vision models.
/// Reference: examples/llama.cpp/llama.cpp/tools/mtmd/models/dotsocr.cpp
/// </summary>
public sealed class DotsOcrVisionModel : IDisposable
{
    ...
    public static DotsOcrVisionModel Open(string path)
    {
        var gguf = GgufModel.Open(path);
        return FromGguf(gguf);
    }

    public static DotsOcrVisionModel FromGguf(GgufModel gguf)
    {
        string projType = "dotsocr";
