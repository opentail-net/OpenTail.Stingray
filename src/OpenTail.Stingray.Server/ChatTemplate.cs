...
/// DI singleton; the <see cref="ServiceCollectionExtensions.AddOpenTailStingray"/> wiring
...
public sealed class ChatTemplateRenderer
{
    ...
    /// <see cref="OpenTailStingrayServerOptions.OutputConstraintFactory"/> can build a
