...
///
/// Usage: dotnet run --project benchmarks/OpenTail.Stingray.Bench -c Release -- --cb
...
public static class ContinuousBatchingHarness
{
    ...
    public static async Task Run(string[] args)
    {
        ...
        // interpretable. Force it off for the "before" numbers with STINGRAY_PREFILL_DEQUANT_MB=0.
