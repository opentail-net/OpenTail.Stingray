...
namespace OpenTail.Stingray.ImageBench;

// ── Micro benchmarks for CUDA backend hot paths ────────────────────────────────
//
// Run with:
//   dotnet run --project benchmarks/OpenTail.Stingray.ImageBench -c Release -- --bench
//
...
public class DiTForwardPassBenchmarks
{
    ...
    public void Setup()
    {
        ...
        _backend = Backend switch
        {
            ...
            _                                           => new OpenTail.Stingray.Cpu.CpuBackend(),
        };

        var loader = OpenTail.Stingray.Diffusion.GgufWeightLoader.Open(ditPath);
